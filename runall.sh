...
gnome-terminal 	--tab -e "bash -c \"source /home/a1101x/projects/mt/server_venv/bin/activate;
		...
		--tab -e "bash -c \"sleep 20; source /home/a1101x/projects/mt/sockets_venv/bin/activate; 
			 cd /home/a1101x/projects/mt/mt_sockets/; pip install -r requirements.txt; 
			 daphne apps.core.asgi:channel_layer --port 8002;\"" \
		--tab -e "bash -c \"sleep 24; source /home/a1101x/projects/mt/sockets_venv/bin/activate; 
			 cd /home/a1101x/projects/mt/mt_sockets/; python manage.py runworker --threads 4 
