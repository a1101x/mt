...
gnome-terminal 	--tab -e "bash -c \"source /home/a1101x/projects/mt/server_venv/bin/activate;
		...
		--tab -e "bash -c \"sleep 12; source /home/a1101x/projects/mt/sockets_venv/bin/activate; 
			 cd /home/a1101x/projects/mt/mt_sockets/; python manage.py runworker;\"" \
		--tab -e "bash -c \"sleep 14; source /home/a1101x/projects/mt/workers_venv/bin/activate; 
			 cd /home/a1101x/projects/mt/mt_workers/; 
			 celery -A mt_workers worker --concurrency=4 -l info;\"" \
		--tab -e "bash -c \"sleep 18; source /home/a1101x/projects/mt/workers_venv/bin/activate; 
